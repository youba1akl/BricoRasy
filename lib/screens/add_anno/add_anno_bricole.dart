import 'dart:io';
import 'dart:convert'; // Import jsonDecode for error parsing
...
class _TaskFormScreenState extends State<TaskFormScreen> {
  ...
  final List<String> _taskTypes = [
    'Jardinage', 'Décoration', 'Nettoyage', 'Réparations',
    'Montage meubles', 'Ménage', 'Déménagement', 'Transport', 'Autre',
  ];
  ...
  Future<void> _submitForm() async {
    ...
    if (_selectedType == null) {
       ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Veuillez choisir un type d\'annonce.'), backgroundColor: Colors.orange),
      );
      return;
    }
     if (_images.isEmpty) {
    ...
    final req = http.MultipartRequest('POST', uri)
      ...
      ..fields['prix'] = _priceCtrl.text.replaceAll(',', '.') // Ensure decimal point
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: _selectedType,
                decoration: inputDecoration('Type de service', Icons.category_outlined),
              ...
              TextFormField(
                ...
                decoration: inputDecoration('Prix (DA)', Icons.local_offer_outlined),
