...
class ToolCard extends StatelessWidget {
  ...
  final DummyTool toolData;
  final VoidCallback onPress;

  const ToolCard({super.key, required this.toolData, required this.onPress});

  @override
  Widget build(BuildContext context) {
    // Extract data from the map
    final imageUrl = toolData.imagePath; // Handle potential null
    final toolName = toolData.name;
    final price = toolData.price;
    final type_annonce = toolData.typeAnnonce;
    ...
    final Color toolShadowColor = Theme.of(
      context,
